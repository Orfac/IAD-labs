...
function onPlotClick(e) {
    if(r === -1) {
        ...
        document.getElementById("j_idt14:hiddenX").value = x.toString();
        document.getElementById("j_idt14:hiddenY").value = y.toString();
        document.getElementById("j_idt14:hiddenR").value = r.toString();
        document.getElementById("j_idt14:ajax-button").click();
...
function onSuccess() {
    let checkResult = document.getElementById("j_idt14:output").textContent;
